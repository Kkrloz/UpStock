    ...
    <div className="flex flex-col gap-6 items-center justify-center min-h-screen max-w-md mx-auto text-center font-sans px-4">
      ...
      <div className="bg-(--bg-card-color) border border-(--border-color) rounded-2xl p-8 shadow-2xl flex flex-col items-center gap-6 w-full">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-(--text-secondary-color)">Você saiu com segurança do UpStock. Volte sempre!</p>
        </div>
        <Link to="/login" className="flex items-center gap-2 bg-(--bg-card-hover-color) hover:bg-(--bg-card-hover-color2) border border-(--border-color) text-(--text-primary-color) font-bold py-2.5 px-6 rounded-xl transition-all duration-200 text-sm shadow-md mt-2 cursor-pointer">
